...
$_sql = "
SELECT
ROUND((((AVG(t_prijzen2020.d_prijzenH2020)-AVG(t_prijzen2019.d_prijzenH2019))/AVG(t_prijzen2019.d_prijzenH2019))*100),2) AS v1j,
AVG(t_prijzen2020.d_prijzenH2020) AS duursteGoedkoopste,
