...
//Gemiddelde percentage 1 jaar in de provincie $_NAAM
  $_sql = "SELECT ROUND((((AVG(t_prijzen2020.d_prijzenH2020)-AVG(t_prijzen2019.d_prijzenH2019))/AVG(t_prijzen2019.d_prijzenH2019))*100),2) AS avgProvincie1j 
  FROM t_prijzen2020 
  ...
  $_sql = "SELECT ROUND((((AVG(t_prijzen2020.d_prijzenH2020)-AVG(t_prijzen2011.d_prijzenH2011))/AVG(t_prijzen2011.d_prijzenH2011))*100),2) AS avgProvincie10j 
  FROM t_prijzen2020 
