...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    $_arrondissementSelectie=33;
    $_arrondissementLimiet=34;
    $_provincie = 'svgVlaamsBrabant';
    $_x='50%';
    $_y='50%';
    $_viewbox='-30 -20 610 260';
    $_provincieNaam='Vlaams-Brabant';
    ...
    $_titelKaartPrijzen="<p class='titKaart'>Provincie Vlaams-Brabant:<br>gemiddelde prijs per gemeente</p>";
    $_titelKaartTransacties="<p class='titKaart'>Provincie Vlaams-Brabant:<br>aantal transacties per gemeente</p>";
