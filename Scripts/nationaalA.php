...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    //ANTWERPEN
    $_provSelectie=1;
    require("../code/nationaalAcode.inc.php");   
...
*/
    ...
    if ($result->num_rows > 0) {     
        ...
        if($_tPROVANTWERPEN>=$_transacties0 && $_tPROVANTWERPEN<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVANTWERPEN').style.fill='aqua';>document.getElementById('tPROVANTWERPEN2').style.fill='aqua';</script>";}
        if($_tPROVANTWERPEN>=$_transacties1 && $_tPROVANTWERPEN<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVANTWERPEN').style.fill='deepskyblue';document.getElementById('tPROVANTWERPEN2').style.fill='deepskyblue';</script>";}
        if($_tPROVANTWERPEN>=$_transacties2 && $_tPROVANTWERPEN<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVANTWERPEN').style.fill='dodgerblue';document.getElementById('tPROVANTWERPEN2').style.fill='dodgerblue';</script>";}
        if($_tPROVANTWERPEN>=$_transacties3 && $_tPROVANTWERPEN<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVANTWERPEN').style.fill='blue';document.getElementById('tPROVANTWERPEN2').style.fill='blue';</script>";}
        if($_tPROVANTWERPEN>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVANTWERPEN').style.fill='darkblue';document.getElementById('tPROVANTWERPEN2').style.fill='darkblue';</script>";}

        if($_tPROVBRUSSEL==0){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='#C8C8C8';</script>";}
        if($_tPROVBRUSSEL>=$_transacties0 && $_tPROVBRUSSEL<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='aqua';</script>";}
        if($_tPROVBRUSSEL>=$_transacties1 && $_tPROVBRUSSEL<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='deepskyblue';</script>";}
        if($_tPROVBRUSSEL>=$_transacties2 && $_tPROVBRUSSEL<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='dodgerblue';</script>";}
        if($_tPROVBRUSSEL>=$_transacties3 && $_tPROVBRUSSEL<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='blue';</script>";}
        if($_tPROVBRUSSEL>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVBRUSSEL').style.fill='darkblue';</script>";}
        ...
        if($_tPROVHAINAUT>=$_transacties0 && $_tPROVHAINAUT<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVHAINAUT').style.fill='aqua';>document.getElementById('tPROVHAINAUT2').style.fill='aqua';</script>";}
        if($_tPROVHAINAUT>=$_transacties1 && $_tPROVHAINAUT<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVHAINAUT').style.fill='deepskyblue';document.getElementById('tPROVHAINAUT2').style.fill='deepskyblue';</script>";}
        if($_tPROVHAINAUT>=$_transacties2 && $_tPROVHAINAUT<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVHAINAUT').style.fill='dodgerblue';document.getElementById('tPROVHAINAUT2').style.fill='dodgerblue';</script>";}
        if($_tPROVHAINAUT>=$_transacties3 && $_tPROVHAINAUT<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVHAINAUT').style.fill='blue';document.getElementById('tPROVHAINAUT2').style.fill='blue';</script>";}
        if($_tPROVHAINAUT>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVHAINAUT').style.fill='darkblue';document.getElementById('tPROVHAINAUT2').style.fill='darkblue';</script>";}
        ...
        if($_tPROVLIMBURG>=$_transacties0 && $_tPROVLIMBURG<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVLIMBURG').style.fill='aqua';>document.getElementById('tPROVLIMBURG2').style.fill='aqua';</script>";}
        if($_tPROVLIMBURG>=$_transacties1 && $_tPROVLIMBURG<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVLIMBURG').style.fill='deepskyblue';document.getElementById('tPROVLIMBURG2').style.fill='deepskyblue';</script>";}
        if($_tPROVLIMBURG>=$_transacties2 && $_tPROVLIMBURG<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVLIMBURG').style.fill='dodgerblue';document.getElementById('tPROVLIMBURG2').style.fill='dodgerblue';</script>";}
        if($_tPROVLIMBURG>=$_transacties3 && $_tPROVLIMBURG<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLIMBURG').style.fill='blue';document.getElementById('tPROVLIMBURG2').style.fill='blue';</script>";}
        if($_tPROVLIMBURG>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLIMBURG').style.fill='darkblue';document.getElementById('tPROVLIMBURG2').style.fill='darkblue';</script>";}

        if($_tPROVLIEGE==0){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='#C8C8C8';</script>";}
        if($_tPROVLIEGE>=$_transacties0 && $_tPROVLIEGE<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='aqua';</script>";}
        if($_tPROVLIEGE>=$_transacties1 && $_tPROVLIEGE<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='deepskyblue';</script>";}
        if($_tPROVLIEGE>=$_transacties2 && $_tPROVLIEGE<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='dodgerblue';</script>";}
        if($_tPROVLIEGE>=$_transacties3 && $_tPROVLIEGE<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='blue';</script>";}
        if($_tPROVLIEGE>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLIEGE').style.fill='darkblue';</script>";}

        if($_tPROVLUXEMBOURG==0){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='#C8C8C8';</script>";}
        if($_tPROVLUXEMBOURG>=$_transacties0 && $_tPROVLUXEMBOURG<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='aqua';</script>";}
        if($_tPROVLUXEMBOURG>=$_transacties1 && $_tPROVLUXEMBOURG<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='deepskyblue';</script>";}
        if($_tPROVLUXEMBOURG>=$_transacties2 && $_tPROVLUXEMBOURG<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='dodgerblue';</script>";}
        if($_tPROVLUXEMBOURG>=$_transacties3 && $_tPROVLUXEMBOURG<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='blue';</script>";}
        if($_tPROVLUXEMBOURG>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVLUXEMBOURG').style.fill='darkblue';</script>";}

        if($_tPROVNAMUR==0){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='#C8C8C8';</script>";}
        if($_tPROVNAMUR>=$_transacties0 && $_tPROVNAMUR<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='aqua';</script>";}
        if($_tPROVNAMUR>=$_transacties1 && $_tPROVNAMUR<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='deepskyblue';</script>";}
        if($_tPROVNAMUR>=$_transacties2 && $_tPROVNAMUR<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='dodgerblue';</script>";}
        if($_tPROVNAMUR>=$_transacties3 && $_tPROVNAMUR<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='blue';</script>";}
        if($_tPROVNAMUR>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVNAMUR').style.fill='darkblue';</script>";}

        if($_tPROVOOSTVLAANDEREN==0){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='#C8C8C8';</script>";}
        if($_tPROVOOSTVLAANDEREN>=$_transacties0 && $_tPROVOOSTVLAANDEREN<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='aqua';</script>";}
        if($_tPROVOOSTVLAANDEREN>=$_transacties1 && $_tPROVOOSTVLAANDEREN<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='deepskyblue';</script>";}
        if($_tPROVOOSTVLAANDEREN>=$_transacties2 && $_tPROVOOSTVLAANDEREN<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='dodgerblue';</script>";}
        if($_tPROVOOSTVLAANDEREN>=$_transacties3 && $_tPROVOOSTVLAANDEREN<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='blue';</script>";}
        if($_tPROVOOSTVLAANDEREN>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVOOSTVLAANDEREN').style.fill='darkblue';</script>";}

        if($_tPROVVLAAMSBRABANT==0){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='#C8C8C8';</script>";}
        if($_tPROVVLAAMSBRABANT>=$_transacties0 && $_tPROVVLAAMSBRABANT<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='aqua';</script>";}
        if($_tPROVVLAAMSBRABANT>=$_transacties1 && $_tPROVVLAAMSBRABANT<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='deepskyblue';</script>";}
        if($_tPROVVLAAMSBRABANT>=$_transacties2 && $_tPROVVLAAMSBRABANT<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='dodgerblue';</script>";}
        if($_tPROVVLAAMSBRABANT>=$_transacties3 && $_tPROVVLAAMSBRABANT<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='blue';</script>";}
        if($_tPROVVLAAMSBRABANT>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVVLAAMSBRABANT').style.fill='darkblue';</script>";}

        if($_tPROVBRABANTWALLON==0){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='#C8C8C8';</script>";}
        if($_tPROVBRABANTWALLON>=$_transacties0 && $_tPROVBRABANTWALLON<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='aqua';</script>";}
        if($_tPROVBRABANTWALLON>=$_transacties1 && $_tPROVBRABANTWALLON<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='deepskyblue';</script>";}
        if($_tPROVBRABANTWALLON>=$_transacties2 && $_tPROVBRABANTWALLON<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='dodgerblue';</script>";}
        if($_tPROVBRABANTWALLON>=$_transacties3 && $_tPROVBRABANTWALLON<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='blue';</script>";}
        if($_tPROVBRABANTWALLON>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVBRABANTWALLON').style.fill='darkblue';</script>";}

        if($_tPROVWESTVLAANDEREN==0){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='#C8C8C8';</script>";}
        if($_tPROVWESTVLAANDEREN>=$_transacties0 && $_tPROVWESTVLAANDEREN<$_transacties1){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='aqua';</script>";}
        if($_tPROVWESTVLAANDEREN>=$_transacties1 && $_tPROVWESTVLAANDEREN<$_transacties2){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='deepskyblue';</script>";}
        if($_tPROVWESTVLAANDEREN>=$_transacties2 && $_tPROVWESTVLAANDEREN<$_transacties3){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='dodgerblue';</script>";}
        if($_tPROVWESTVLAANDEREN>=$_transacties3 && $_tPROVWESTVLAANDEREN<$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='blue';</script>";}
        if($_tPROVWESTVLAANDEREN>=$_transacties4){$_kaartTransacties.="<script>document.getElementById('tPROVWESTVLAANDEREN').style.fill='darkblue';</script>";}
        }     
    } 
    require("../code/nationaalAcode.inc.php"); 
    ...
    $_symbool='%';
    require("../code/codePijlen.inc.php");
    ...
    $_q1="d_quote1_NL";
    $_q2="d_quote2_NL";
    $_sql = "SELECT * FROM `t_artikels` WHERE `d_indexProvincies`=12 AND d_indexArtikels=39";
    ...
    $_tabelPrijzen.="<tr class='provincieRij'><td class='first'>&nbsp;België</td>";
       ...
       if ($_result->num_rows > 0) {
           while($row = $_result->fetch_assoc()) {  
               ...
               $_cijfer= "<p class=cijferA>".number_format($row['sumTransacties'], 0, ',','.')."</p><p class=cijferTekst>In Belgiê zijn er ".number_format($row['sumTransacties'], 0, ',','.')." appartementen verkocht.</p>";  
           }
       }
...
*/
    ...
    $_smarty->display('BVP_nationaalA.tpl');
}
