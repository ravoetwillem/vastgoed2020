...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    $_arrondissementSelectie=1;
    $_arrondissementLimiet=3;
    $_provincie = 'svgAntwerpen';
    $_x='50%';
    $_y='50%';
    $_viewbox='-15 -20 450 330';
    ...
    $_titelKaartPrijzen="<p class='titKaart'>Provincie Antwerpen:<br>gemiddelde prijs per gemeente</p>";
    $_titelKaartTransacties="<p class='titKaart'>Provincie Antwerpen:<br>aantal transacties per gemeente</p>";
