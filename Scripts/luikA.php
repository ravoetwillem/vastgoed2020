...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    $_arrondissementSelectie=15;
    $_arrondissementLimiet=18;
    $_provincie = 'svgLuik';
    $_x='50%';
    $_y='50%';
    $_viewbox='-23 -20 620 470';
    $_provincieNaam="Luik";
    ...
    $_titelKaartPrijzen="<p class='titKaart'>Provincie Luik:<br>gemiddelde prijs per gemeente</p>";
    $_titelKaartTransacties="<p class='titKaart'>Provincie Luik:<br>aantal transacties per gemeente</p>";
