...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    $_arrondissementSelectie=27;
    $_arrondissementLimiet=32;
    $_provincie = 'svgOostVlaanderen';
    $_x='50%';
    $_y='50%';
    $_viewbox='-30 -10 500 450';
    $_provincieNaam="Oost-Vlaanderen";
    ...
    $_titelKaartPrijzen="<p class='titKaart'>Provincie Oost-Vlaanderen:<br>gemiddelde prijs per gemeente</p>";
    $_titelKaartTransacties="<p class='titKaart'>Provincie Oost-Vlaanderen:<br>aantal transacties per gemeente</p>";
