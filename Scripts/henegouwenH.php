...
try
{
  ...
  require_once("../Connections/pdo.inc.php");
    ...
    $_arrondissementSelectie=5;
    $_arrondissementLimiet=11;
    $_provincie = 'svgHenegouwen';
    $_x='50%';
    $_y='50%';
    $_viewbox='-5 -10 580 450';
    $_provincieNaam="Henegouwen";
    ...
    $_titelKaartPrijzen="<p class='titKaart'>Provincie Henegouwen:<br>gemiddelde prijs per gemeente</p>";
    $_titelKaartTransacties="<p class='titKaart'>Provincie Henegouwen:<br>aantal transacties per gemeente</p>";
