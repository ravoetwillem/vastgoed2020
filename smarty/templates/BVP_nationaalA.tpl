...
<head>
        ...
        <title>NATIONAAL APPARTEMENTEN</title>
    </head>
        ...
        <div class="container-fluid">
            ...
            <div class="row no-gutters kaarten kaartenSafari">
                <div class=" col-md-6 kaart container-fluid" id="kaartKP">
                        ...
                        {$kaartPrijzen}
                        <br>
                        <svg version="1.0" class="legendeSafari" id="legendePrijsA" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                            ...
                            <text transform="matrix(1 0 0 1 5.3414 17.618)" font-family="'RegulatorNova-bold' !important" font-size="16px">Legende prijzen appartementen (in €)</text>
                        </svg>
                ...
                <div class=" col-md-6 kaart container-fluid" id="kaartKT">
                            {$titelKaartTransacties}
                            <div id="infoVeld2"> </div>
                            <div class="divKaart">
                            {$kaartTransacties}
                            <br>
                            <svg version="1.0" class="legendeSafari" id="legendeTransactiesA" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 579.952 125.364"
                            enable-background="new 0 0 579.952 125.364" xml:space="preserve">
                                <rect x="5.229" y="28.145" fill="aqua" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="41.194" y="28.145" fill="deepskyblue" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="77.158" y="28.145" fill="dodgerblue" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="113.123" y="28.145" fill="blue" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="149.087" y="28.145" fill="darkblue" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="185.052" y="28.145" fill="#C0C0BF" stroke="#FFFFFF" stroke-miterlimit="10" width="31.354" height="13.143"/>
                                <rect x="15.945" y="46.288" fill="none" width="16.271" height="60.164"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 24.8112 76)" font-family="'RegulatorNova-medium' !important" font-size="13px">0-50</text>
                                <rect x="52.001" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 60.8665 87)" font-family="'RegulatorNova-medium' !important" font-size="14px">51-100</text>
                                <rect x="88.056" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 96.9218 94.5)" font-family="'RegulatorNova-medium' !important" font-size="14px">101-200</text>
                                <rect x="124.111" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 132.9772 96)" font-family="'RegulatorNova-medium' !important" font-size="14px">201-500</text>
                                <rect x="160.167" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 169.0325 82)" font-family="'RegulatorNova-medium' !important" font-size="14px">&gt; 500</text>
                                ...
                                <text transform="matrix(1 0 0 1 5.3414 17.618)"><tspan x="0" y="0" font-family="'RegulatorNova-Bold' !important" font-size="16px">Legende transacties appartementen</text>
                        </svg>
                    </div>
                </div>
            </div>   
            ...
            <div class="row no-gutters">
                <div class="col-12 col-md-12 col-lg-3 order-3 order-md-4 order-lg-1 container-fluid blok2 blok1">
                    <div class="row no-gutters">
                        <div class="col-12 col-xs-6 col-sm-6 col-md-3 col-lg-12 order-sm-1 order-md-1" id="sterksteStijger"><div class="pijlPositive">{$sterksteStijger}</div></div>
                        <div class="col-12 col-xs-6 col-sm-6 col-md-3 col-lg-12 order-sm-3 order-md-2" id="sterksteDaler"><div class="pijlNegative">{$sterksteDaler}</div></div>
                        <div class="col-12 col-xs-6 col-sm-6 col-md-3 col-lg-12 order-sm-2 order-md-3" id="duursteGemeente"><div class="pijlPositive">{$duursteGemeente}</div></div>
                        <div class="col-12 col-xs-6 col-sm-6 col-md-3 col-lg-12 order-sm-4 order-md-4" id="goedkoopsteGemeente"><div class="pijlNegative">{$goedkoopsteGemeente}</div></div>
                    </div>
                </div>
                <div class="col-12 col-md-8 col-lg-6 order-1 order-md-1 order-lg-2 container-fluid blok2"> 
                    <div class="row no-gutters">
                        <div class="col-12  col-lg-12 artikel" id="artikel">{$artikel}</div>
                        <div class="col-12  col-lg-12" id="tabelPrijzen">{$tabelPrijzen}</div>
                    </div>
                </div>    
                <div class="col-12 col-md-3 col-lg-3 order-2 order-md-2 order-lg-3 container-fluid blok2 blok3">
                    <div class="row no-gutters">
                        <div class="col-12  col-sm-4 col-md-12 order-2 order-md-1" id="quote1">{$quote1}</div>
                        <div class="col-12 col-sm-4 col-md-12 order-3 order-md-2" id="quote2">{$quote2}</div>
                        <div class="col-12 col-sm-4 col-md-12  order-4 order-md-3" id="cijfer">{$cijfer}</div>
                        <div class="col-12 order-1 order-md-4" id="kaderstuk">{$kaderstuk}</div>
                    </div>
                </div>
            </div>
        ...
        <br><br><br>
            ...
            <div class="row no-gutters">
                <div class="voetnoot container-fluid col-12  ">
                    &copy;  <script language="JavaScript" type="text/javascript">var nu = new Date();document.writeln( nu.getFullYear());</script> - Vormgeving en Programatie: Willem Ravoet - Bron cijfers: Statbel
                </div>
            </div>
