<?php
/* Smarty version 3.1.31, created on 2022-06-11 16:17:03
  from "/Users/willemravoet/BESTANDEN/MAMP/Project /smarty/templates/BVP_provinciesA.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_62a4bfff9c9309_33708324',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6a663cb2f3cef168d057e44aadea46310fc40a0c' => 
    array (
      0 => '/Users/willemravoet/BESTANDEN/MAMP/Project /smarty/templates/BVP_provinciesA.tpl',
      1 => 1654857474,
      2 => 'file',
    ),
  ),
...
function content_62a4bfff9c9309_33708324 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="nl">
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="container-fluid order-1 row no-gutters header">
                    <div id="header" class="col-sm-12 "><h1 class="titHeader">De Belgische <span class="bold t1span">Vastgoedprijzen <span class="boldBlue">2020</span></span></h1></div>
                </div>
            ...
            <div class="row no-gutters kaarten">
                <div class=" col-md-6 kaart container-fluid" id="kaartKP">
                    ...
                    <div class="divKaart">
                        ...
                        <br>
                        <svg version="1.0" id="legendePrijsA" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                            ...
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 24.8112 101)" font-family="'RegulatorNova-medium'" text-align="right" font-size="14px">&lt; 100.000</text>
                            <rect x="52.001" y="56.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 60.8665 92.5)" font-family="'RegulatorNova-medium'" text-align="right" font-size="14px">100.000</text>
                            <rect x="8.056" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 96.9218 92)" font-family="'RegulatorNova-medium'" font-size="14px">125.000</text>
                            <rect x="124.111" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 132.9772 92.4)" font-family="'RegulatorNova-medium'" font-size="14px">150.000</text>
                            <rect x="160.167" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 169.0325 91)" font-family="'RegulatorNova-medium'" font-size="14px">175.000</text>
                            <rect x="196.222" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 205.0878 95.8158)" font-family="'RegulatorNova-medium'" font-size="14px">200.000</text>
                            <rect x="232.277" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 241.1432 95)" font-family="'RegulatorNova-medium'" font-size="14px">225.000</text>
                            <rect x="268.333" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 277.1985 95.5)" font-family="'RegulatorNova-medium'" font-size="14px">250.000</text>
                            <rect x="304.388" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 313.2538 94)" font-family="'RegulatorNova-medium'" font-size="14px">275.000</text>
                            <rect x="340.443" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 349.3092 96)" font-family="'RegulatorNova-medium'" font-size="14px">300.000</text>
                            <rect x="376.499" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 385.3645 95.0121)" font-family="'RegulatorNova-medium'" font-size="14px">325.000</text>
                            <rect x="412.554" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 421.4198 96)" font-family="'RegulatorNova-medium'" font-size="14px">350.000</text>
                            <rect x="448.609" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 457.4752 94.5)" font-family="'RegulatorNova-medium'" font-size="14px">375.000</text>
                            <rect x="484.665" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 493.5305 97)" font-family="'RegulatorNova-medium'" font-size="14px">400.000</text>
                            <rect x="520.72" y="46.288" fill="none" width="16.271" height="60.164"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 529.5858 106)" font-family="'RegulatorNova-medium'" font-size="14px">&gt; 400.000</text>
                            <rect x="556.775" y="46.288" fill="none" width="16.271" height="76.735"/>
                            <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 565.6406 121.3832)" font-family="'RegulatorNova-medium'" font-size="14px">onbekend</text>
                            <rect x="5.341" y="7.388" fill="none" width="230.4" height="19.2"/>
                            <text transform="matrix(1 0 0 1 5.3414 17.618)" font-family="'RegulatorNova-bold'" font-size="16px">Legende prijzen villa's (in €)</text>
                        </svg>
                    ...
                    <div class="divKaart">
                        ...
                        <svg version="1.0" id="legendeTransactiesH" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                            ...
                            enable-background="new 0 0 579.952 125.364" xml:space="preserve">
                                ...
                                <rect x="15.945" y="46.288" fill="none" width="16.271" height="60.164"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 24.8112 76)" font-family="'RegulatorNova-Medium'" font-size="13px">0-50</text>
                                <rect x="52.001" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 60.8665 87)" font-family="'RegulatorNova-Medium'" font-size="14px">51-100</text>
                                <rect x="88.056" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 96.9218 94.5)" font-family="'RegulatorNova-Medium'" font-size="14px">101-200</text>
                                <rect x="124.111" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 132.9772 96)" font-family="'RegulatorNova-Medium'" font-size="14px">201-500</text>
                                <rect x="160.167" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 169.0325 82)" font-family="'RegulatorNova-Medium'" font-size="14px">&gt; 500</text>
                                <rect x="196.222" y="46.288" fill="none" width="16.271" height="73"/>
                                <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 205.0873 121.3832)" font-family="'RegulatorNova-Medium'" font-size="14px">onbekend</text>
                                <rect x="5.341" y="7.388" fill="none" width="215.675" height="19.2"/>
                                <text transform="matrix(1 0 0 1 5.3414 17.618)"><tspan x="0" y="0" font-family="'RegulatorNova-Bold'" font-size="16px">Legende transacties appartementen</text>
                        </svg>
                    </div>
                </div>
            </div>   
            ...
            <div class="row no-gutters">
                <div class="col-12 col-md-12 col-lg-3 order-3 order-md-4 order-lg-1 container-fluid blok2">
                    <div class="row no-gutters">
                ...
                <div class="col-12 col-md-3 col-lg-3 order-2 order-md-2 order-lg-3 container-fluid blok2">
                    <div class="row no-gutters">
